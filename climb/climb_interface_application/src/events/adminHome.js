...
function dashboardbtn(maincontent) {
    loadIframe(maincontent, "../page/adminDashboard");
}

function funcionariosbtn(maincontent) {
    loadIframe(maincontent, "../page/adminFuncionarios.html");
}

function accountBtn(maincontent) {
    loadIframe(maincontent, "../page/perfil.html");
}

function setoresBtn(maincontent) {
    loadIframe(maincontent, "../page/adminSetores.html");
}
